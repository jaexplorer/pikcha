...
const UploadModal = ({
  ...
  const { title, location, caption, price, signature, tags, imageFile } = image;
  ...
  useEffect(() => {
    account.signature &&
      setImage({ ...image, signature: account.signature.orgSig });
  }, [account.signature]);
          ...
          <div className='form-section'>
            ...
            <div className='description'>
              <div className='input-wrapper'>
                ...
                <div className='textarea-counter'>{380 - caption.length}</div>
              </div>
            </div>
